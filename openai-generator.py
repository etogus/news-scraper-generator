...
- Быть написана в формальном новостном стиле
...
def generate_article(headline, lead, approach="universal"):
    """
    Generate article using OpenAI GPT with the specified prompt approach.
    """
